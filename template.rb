...
# Overwrites app/assets/tailwind/application.css (the actual Tailwind compiler input)
...
create_file "app/assets/tailwind/application.css", tailwind_css, force: true

say "Tailwind theme applied to app/assets/tailwind/application.css.", :green
say "\nSetup complete.", :blue
